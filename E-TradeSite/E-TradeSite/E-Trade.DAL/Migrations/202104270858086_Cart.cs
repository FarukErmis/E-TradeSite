                ...
                c => new
                    {
                        ...
                        ShopCampaignId = c.Int(),
                        MemberId = c.Int(),
                        ShopTokenId = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Members", t => t.MemberId)
                .ForeignKey("dbo.ShopCampaigns", t => t.ShopCampaignId)
                .ForeignKey("dbo.ShopTokens", t => t.ShopTokenId)
                .Index(t => t.ShopCampaignId)
                .Index(t => t.MemberId)
