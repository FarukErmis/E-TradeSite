namespace E_Trade.DAL.Migrations
{
    ...
    public partial class SpecToProduct : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        SpecGroupId = c.Int(),
                        SpecNameId = c.Int(),
                        SpecValueId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Products", t => t.ProductId)
                .ForeignKey("dbo.SpecGroup", t => t.SpecGroupId)
                .ForeignKey("dbo.SpecNames", t => t.SpecNameId)
                .ForeignKey("dbo.SpecValues", t => t.SpecValueId, cascadeDelete: true)
                .Index(t => t.ProductId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SpecToProducts", "SpecNameId", "dbo.SpecNames");
